...
if %fireOsVersion%==5.2.6.3 (
	echo 1. Continue Without Changing Firmware Version
	echo.
	echo 2. Upgrade To Version 5.2.7.2
	echo.
	echo 3. Re-Install Version 5.2.6.3
	echo.
	set /p fwselect=
	echo.
	if %fwselect%==1 (
	...
	if %fwselect%==3 (
		...
		set unreleased=0
		set ugversion=0.0.0.0
		set dgversion=5.2.6.3
		goto fwnext
	)
	if %fwselect%==0 goto fwcheck
	if %fwselect% gtr 3 goto fwcheck
)

if %fireOsVersion% lss 5.2.7.2 (
	echo 1. Continue Without Changing Firmware Version
	echo.
	echo 2. Upgrade To Version 5.2.7.2
	echo.
	echo 3. Downgrade To 5.2.6.3
	echo.
	set /p fwselect=
	echo.
	if %fwselect%==1 (
...
if %fireOsVersion%==5.2.7.2 (
	echo 1. Continue Without Changing Firmware Version
	echo.
	echo 2. Re-Install Version 5.2.7.2
	echo.
	echo 3. Downgrade To 5.2.6.3
	echo.
	set /p fwselect=
...
if %fireOsVersion% gtr 5.2.7.2 (
	echo 1. Continue Without Changing Firmware Version
	echo.
	echo 2. Downgrade To 5.2.7.2
	echo.
	set /p fwselect=
	echo.
	if %fwselect%==1 (
	...
	if %fwselect%==0 goto fwcheck
	if %fwselect% gtr 2 goto fwcheck
)

:fwnext
if %downgrade%==1 (
if %dgversion%==5.2.6.3 goto is5263
if %dgversion%==5.2.7.2 goto is5272
)

if %upgrade%==1 (
if %ugversion%==5.2.7.2 goto is5272
)

if %downgrade%==0 (
if %dgversion%==5.2.6.3 goto is5263
if %dgversion%==5.2.7.2 goto is5272
if %dgversion% gtr 5.2.6.3 goto is5272
if %dgversion% gtr 5.2.7.2 goto is5272
if %unreleased%==1 goto is5272
)

if %dgversion%==0.0.0.0 (
if %fireOsVersion%==5.2.6.3 goto is5263
if %fireOsVersion%==5.2.7.2 goto is5272
if %fireOsVersion% gtr 5.2.6.3 goto is5272
if %fireOsVersion% gtr 5.2.7.2 goto is5272
if %unreleased%==1 goto is5272
)
goto fwcheck

:: Pre-check for 5.2.6.3
:is5263
cls
%cocolor% 0a
echo TWRP Found!
...
echo.
if %downgrade%==1 echo - Downgrade To Stock Amazon FireOS 5.2.6.3
if %reinstall%==1 echo - Re-Install Stock Amazon FireOS 5.2.6.3
...
if %noway%==1 goto end
if %noway%==b (
	%twrp% backup /system,data,cache,dalvik
	%adb% reboot recovery
	%sleep% 25
	goto start
)
...
echo The device will have the following done to it:
echo.
if %upgrade%==1 echo - Upgrade To Stock Amazon FireOS 5.2.7.2
if %downgrade%==1 echo - Downgrade To Stock Amazon FireOS 5.2.7.2
if %reinstall%==1 echo - Re-Install Stock Amazon FireOS 5.2.7.2
echo - Amazon Bloat Removed
echo - Custom Home Menu and Data Installed To System
echo - TitaniumBackup Installed To System. Use To Restore All Apps and Data
echo - SH Script Runner Installed To System. Use For Shortcuts On Home Menu
...
if %downgrade%==1 (
if %dgversion%==5.2.6.3 goto do5263
if %dgversion%==5.2.7.2 goto do5272
)

if %upgrade%==1 (
if %ugversion%==5.2.7.2 goto do5272
)
goto stage2

:: Only land here if downgrading or reinstalling 5.2.6.3 stock rom
:do5263
if %downgrade%==1 (
	cls
	echo Preparing Stock FireOS 5.2.6.3 Files
	echo.
...
:: Only land here if downgrading or reinstalling 5.2.7.2 stock rom
:do5272
if %upgrade%==1 (
	cls
	echo Preparing Stock FireOS 5.2.7.2 Files
	echo.
	if not exist "%temp%\firestick-loader\downgrade\stick2\5.2.7.2" md "%temp%\firestick-loader\downgrade\stick2\5.2.7.2"
	%extractRAR% "roms\stick2\5.2.7.2\5.2.7.2-stock-rooted.split" "%temp%\firestick-loader\downgrade\stick2"

	cls
	echo Pushing Upgrade Zip to /sdcard/...
	echo.
	%push% "%temp%\firestick-loader\downgrade\stick2\tank-5.2.7.2-rooted_r2.zip" /sdcard/
	%sleep% 2
	...
	cls
	echo Installing Stock FireOS 5.2.7.2...
	echo.
	%twrp% install /sdcard/tank-5.2.7.2-rooted_r2.zip
	%sleep% 5
	...
	echo.
	rd /s /q "%temp%\firestick-loader\downgrade\stick2"
	%shell% "rm /sdcard/tank-5.2.7.2-rooted_r2.zip"
	%sleep% 2
	goto stage1a
)

:: Land here as default no downgrade/upgrade
:: Also land here after a downgrade/upgrade has been done
:stage1a
cls
...
:stage2a
if %downgrade%==1 goto stage2b
if %upgrade%==1 goto stage2b
...
%sleep% 3
echo [DEBUG] Preparing To Debloat Apps
echo [DEBUG] downgrade: %downgrade%
echo [DEBUG] dgversion: %dgversion%
echo [DEBUG] ugversion: %ugversion%
pause
...
cls
echo Pushing Restore Home Scripts to Temp...
echo.
