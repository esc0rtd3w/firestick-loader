...
cls
%_color% 0e
set appName=CBS Sports
set apk=
echo.
echo.
echo Installing %appName%...
echo.
%install% "apps\media\sports\cbs-sports-amazon.apk"
...
echo Installing %appName%...
echo.
%install% "apps\media\sports\espn-amazon.apk"
...
echo Installing %appName%...
echo.
%install% "apps\media\sports\fite.apk"

::cls
::%_color% 0e
::set appName=FOX Sports
::set apk=
::echo.
::echo.
::echo Installing %appName%...
::echo.
::%install% "apps\media\sports\fox-sports-amazon.apk"
...
echo Installing %appName%...
echo.
%install% "apps\media\sports\mlb-tv-amazon.apk"
...
echo Installing %appName%...
echo.
%install% "apps\media\sports\nba-amazon.apk"

cls
%_color% 0e
set appName=NBC Sports
set apk=
echo.
echo.
echo Installing %appName%...
echo.
%install% "apps\media\sports\nbc-sports-amazon.apk"
...
echo Installing %appName%...
echo.
md "%temp%\firestick-loader\apps\media\sports\"
%extractRAR% "%~dp0apps\media\sports\nfl-amazon.split" "%temp%\firestick-loader\apps\media\sports"
%sleep% 3
%install% "%temp%\firestick-loader\apps\media\sports\nfl-amazon.apk"
...
::echo Installing %appName%...
::echo.
::%install% "apps\media\sports\ufc.apk"

::cls
::%_color% 0e
::set appName=Vola Sports
::set apk=
::echo.
::echo.
::echo Installing %appName%...
::echo.
::%install% "apps\media\sports\vola-sports.apk"

::cls
::%_color% 0e
::set appName=WOW Sports Live
::set apk=
::echo.
::echo.
::echo Installing %appName%...
::echo.
::%install% "apps\media\sports\wow-sports-live.apk"
