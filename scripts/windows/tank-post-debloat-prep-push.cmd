...
%shell% "su -c chmod 0755 /system/restore/apk/"

:: Copy APKs To System
%shell% "su -c cp /data/local/tmp/busybox.apk /system/restore/apk/"
%shell% "su -c cp /data/local/tmp/mouse-toggle.apk /system/restore/apk/"

::%shell% "su -c chmod 0644 -R /system/restore/apk/"
%shell% "su -c chown root:root -R /system/restore/apk/"
