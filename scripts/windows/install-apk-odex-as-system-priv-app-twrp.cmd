...
%push% "..\install-odex-as-system-priv-app-twrp.sh" /data/local/tmp/
%shell% "chmod 777 /data/local/tmp/install-odex-as-system-priv-app-twrp.sh"
%shell% "sh /data/local/tmp/install-odex-as-system-priv-app-twrp.sh %name%"
