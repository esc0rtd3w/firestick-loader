...
%shell% "su -c rm -r %sdcard%/system/app"
%shell% "su -c rm -r %sdcard%/system/priv-app"

%shell% "su -c mkdir -p %sdcard%/system/app"
%shell% "su -c mkdir -p %sdcard%/system/priv-app"

%shell% "su -c cp -R /system/app /%sdcard%/system"
%shell% "su -c cp -R /system/priv-app /%sdcard%/system"
