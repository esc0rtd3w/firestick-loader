...
%push% "..\install-odex-as-system-priv-app.sh" /data/local/tmp/
%shell% "su -c chmod 777 /data/local/tmp/install-odex-as-system-priv-app.sh"
%shell% "su -c sh /data/local/tmp/install-odex-as-system-priv-app.sh %name%"
